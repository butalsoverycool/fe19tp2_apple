...
class Chart extends Component {
    ...
    getMatches() {
        ...
        axios.post(url, this.props.apiData.query, { headers: { 'Authorization': 'Access-Control-Allow-Origin' } })
            .then(res => {
        ...
        return (
            <div>
                <Styled.Wrapper>
                    ...
                    <Styled.ChartHeader>{this.props.apiData.chartHeader(this.state)}</Styled.ChartHeader>
                    ...
                    <Styled.CustomizeBox justifyContent='space-between'>
                        <div>
                            <p>FROM</p>
                            <Styled.CustomizeBtn onClick={() => this.pushLimit('from', 'dec')} margin='0'>-</Styled.CustomizeBtn>
                            <Styled.CustomizeBtn onClick={() => this.pushLimit('from', 'inc')} margin='0'>+</Styled.CustomizeBtn>
                        </div>

                        <Styled.InnerTable>
                            <Styled.CustomizeBtn
                                onClick={() => this.lastLimit(1)}
                                w='80px'>
                                last 1
                                </Styled.CustomizeBtn>
                            <Styled.CustomizeBtn
                                onClick={() => this.lastLimit(3)}
                                w='80px'>
                                last 3
                                </Styled.CustomizeBtn>
                            <Styled.CustomizeBtn
                                onClick={() => this.lastLimit(5)}
                                w='80px'>
                                last 5
                                </Styled.CustomizeBtn>
                            <Styled.CustomizeBtn
                        ...
                        <div>
                            <p>TO</p>
                            <Styled.CustomizeBtn onClick={() => this.pushLimit('to', 'dec')} margin='0'>-</Styled.CustomizeBtn>
                            <Styled.CustomizeBtn onClick={() => this.pushLimit('to', 'inc')} margin='0'>+</Styled.CustomizeBtn>
                        </div>
